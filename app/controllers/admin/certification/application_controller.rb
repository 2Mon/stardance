class Admin::Certification::ApplicationController < Admin::ApplicationController
  ...
  # The way through to the second stage. Global only: a mission's own dash
  # overrides this with nil, since the T2 queue spans every hardware project
  # rather than one mission's.
